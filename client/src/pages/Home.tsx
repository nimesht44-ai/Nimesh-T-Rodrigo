        ...
        <section id="home" className="min-h-[90vh] flex flex-col-reverse md:flex-row items-center justify-center gap-12 md:gap-24 pt-20">
          ...
          >
            <div className="flex items-center gap-4 mb-6">
              ...
              <h2 className="text-primary font-bold tracking-widest text-sm uppercase"></h2>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 mb-10 w-full flex-wrap">
              <a href="mailto:theekshanann322@gmail.com" className="flex items-center gap-3 text-sm text-gray-300 hover:text-primary transition-colors group bg-white/5 px-4 py-2 rounded-full border border-white/10">
            ...
            <div className="flex flex-wrap items-center gap-6">
              ...
              <div className="flex items-center gap-3">
                ...
                <a href="https://www.instagram.com/nimesh_t44/" target="_blank" rel="noopener noreferrer" className="p-3 rounded-xl bg-white/5 border border-white/10 hover:border-primary/50 hover:text-primary text-gray-300 transition-all hover:-translate-y-1">
                  <Instagram className="w-5 h-5" />
                </a>
                <a href="https://x.com/Nimesh_T44" target="_blank" rel="noopener noreferrer" className="p-3 rounded-xl bg-white/5 border border-white/10 hover:border-primary/50 hover:text-primary text-gray-300 transition-all hover:-translate-y-1">
                  <Twitter className="w-5 h-5" />
                </a>
                <a href="https://github.com/nimesht44-ai" target="_blank" rel="noopener noreferrer" className="p-3 rounded-xl bg-white/5 border border-white/10 hover:border-primary/50 hover:text-primary text-gray-300 transition-all hover:-translate-y-1">
